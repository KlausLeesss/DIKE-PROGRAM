...
class SelfReportUser extends React.Component {
    constructor(props){
        super(props);
        this.state = {
    ...
    render() {
        const columns1 = [
            ...
            },
            {
                ...
                dataIndex: 'userName',
                key: 'userName',
                render: (text,record) => <Link to={{pathname:'/personProjectUser/'+record.userName}}>{text}</Link>,
                width:300
            },
            {
                title: '下载周报',
