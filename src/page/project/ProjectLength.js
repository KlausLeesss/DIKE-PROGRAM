...
const _mm = new MUtil();
class ProjectLength extends React.Component {
    ...
    deleteThisProject(record){                      //删除项目
        ...
        axios({
            ...
            if(response.data.code === 0){
                ...
                swal("错误提醒","项目删除"+response.data.msg,"warning");
            }
        }).catch(error => {
            console.log(error);
        })
            ...
            },
            {
                ...
                render: (text, record) => (
                    <span>
                        ...
                        <a onClick={this.deleteThisProject.bind(this,record)}>删除项目</a>
                    </span>
                ),
            },
        ];
