...
function styled(type, options, settings) {
  ...
  const hasModifiers = Object.keys(styles).some(className => className !== componentClassName);
  ...
  function Styled(rawProps, ref) {
    ...
    let className = childProps.className ? `${childProps.className} ${componentClassName}` : componentClassName;
